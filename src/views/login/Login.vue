...
<!--    <div class="team-name hidden-sm-and-down"><img src="@/assets/img/login/team-name.png" alt="logo" /></div>-->
    <div class="form-box" v-loading="loading" element-loading-background="rgba(0, 0, 0, 0)">
      <div class="title"><h1 title="Lin">OPENVPN CMS</h1></div>
      <form class="login-form" autocomplete="off" @submit.prevent="throttleLogin()">
        <div class="form-item nickname">
          <span class="icon account-icon"></span>
          <input type="text" v-model="form.username" autocomplete="on" placeholder="请填写用户名" />
        </div>
...
.login {
  ...
  /*background: #1b2c5f url('../../../public/icons/login-ba-bak.png') no-repeat center center;*/
